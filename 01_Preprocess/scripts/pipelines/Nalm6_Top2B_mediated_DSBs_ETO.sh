...
parallel-fastq-dump --sra-id SRX2843836 --threads 8 --split-files --gzip
...
# genome alignment
bowtie -l 50 -n 3 --best --strata --all -k 1 -t --sam ${path_to_ref}/genome.fa reads_1_trimmed.fq.gz > output.sam.gz
